...
public class ServiceExceptionType extends CommonServiceExceptionType {
    ...
    public static final CommonServiceExceptionType CONFIGURATION_ERROR_CONTACT_NOT_EXTERNALLY_PUBLISHED = create("exception.common_metadata.configuration.contact.not_externally_published");
    public static final CommonServiceExceptionType CONFIGURATION_ERROR_CONTACT_NOT_FOUND                = create("exception.common_metadata.configuration.contact.not_found");
