...
public interface SrmRestInternalFacade {
    ...
    ExternalItemsResult findAgencySchemes(ServiceContext serviceContext, SrmItemSchemeRestCriteria criteria, int firstResult, int maxResults) throws MetamacWebException;
