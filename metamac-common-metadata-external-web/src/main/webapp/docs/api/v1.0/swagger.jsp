      ...
      "/v1.0/configurations":{
         "get":{
            ...
            "responses":{
               ...
               "503":{
                  "description":"Servicio no disponible. Indica que actualmente el servidor no est� disponible y por tanto, la solicitud no puede procesarse. El error puede deberse a una sobrecarga temporal o a labores de mantenimiento del servidor. Se trata de una situaci�n temporal."
               }
            }
         }
      },
